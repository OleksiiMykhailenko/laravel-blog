...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; 2020 <a href="https://www.instagram.com/alewami/">Blog, </a> Designed with <i
                                class="fa fa-heart"></i> by <a href="https://www.instagram.com/alewami/">Oleksii</a>
                    </div>
                </div>
            </div>
        </div>
